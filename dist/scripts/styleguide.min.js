!function(t) {
    ...
    var e = function(e, n, o, i) {
        this.target = e, this.url = n, this.html = [], this.effectQueue = [], this.options = t.extend({
            ...
            onData: function() {},
            success: function() {}
        }, o || {}), this.options.ssl && "www.feedrapp.info" === this.options.host && (this.options.host = "feedrapp.herokuapp.com"), 
        this.callback = i || this.options.success;
    };
    ...
    e.prototype.load = function(e) {
        var n = "http" + (this.options.ssl ? "s" : ""), o = n + "://" + this.options.host, i = o + "?callback=?&q=" + encodeURIComponent(this.url);
        this.options.offsetStart && this.options.offsetEnd && (this.options.limit = this.options.offsetEnd), 
        null !== this.options.limit && (i += "&num=" + this.options.limit), null !== this.options.key && (i += "&key=" + this.options.key), 
        t.getJSON(i, e);
        ...
        this.load(function(n) {
            ...
            if (e.target.append(i.layout), 0 !== i.entries.length) {
                ...
                var s = t(i.layout).is("entries") ? i.layout : t("entries", i.layout);
                e.appendEntriesAndApplyEffects(s, i.entries);
            }
        ...
        t.each(n, function(t, n) {
            var i = o.wrapContent(n);
            "show" === o.options.effect ? e.before(i) : (i.css({
                display: "none"
            }), e.before(i), o.applyEffect(i, o.options.effect));
        }), e.remove();
        ...
        return t(this.entries).each(function() {
            var t, o = this, i = e.options.offsetStart, s = e.options.offsetEnd;
            i && s ? index >= i && index <= s && e.isRelevant(o, n.entries) && (t = e.evaluateStringForEntry(e.options.entryTemplate, o), 
            n.entries.push(t)) : e.isRelevant(o, n.entries) && (t = e.evaluateStringForEntry(e.options.entryTemplate, o), 
            n.entries.push(t));
        }), this.options.entryTemplate ? n.layout = this.wrapContent(this.options.layoutTemplate.replace("{entries}", "<entries></entries>")) : n.layout = this.wrapContent("<div><entries></entries></div>"), 
        n;
        ...
        var n = function() {
            var o = e.effectQueue.pop();
            o ? e.applyEffect(o.element, o.effect, n) : t && t();
        };
        n();
        ...
        return t(e.match(/(\{.*?\})/g)).each(function() {
            var t = this.toString();
            o = o.replace(t, i.getValueForToken(t, n));
        }), o;
    }, e.prototype.isRelevant = function(t, e) {
        var n = this.getTokenMap(t);
        return this.options.filter ? this.options.filterLimit && this.options.filterLimit === e.length ? !1 : this.options.filter(t, n) : !0;
        ...
        if ("undefined" != typeof moment) {
            ...
            return e = e.locale ? e.locale(this.options.dateLocale) : e.lang(this.options.dateLocale), 
            e.format(this.options.dateFormat);
        }
        return t;
    }, e.prototype.getTokenMap = function(n) {
        if (!this.feedTokens) {
            var o = JSON.parse(JSON.stringify(this.feed));
            delete o.entries, this.feedTokens = o;
        }
        return t.extend({
            ...
            bodyPlain: function(t) {
                for (var n = t.content.replace(/<script[\\r\\\s\S]*<\/script>/gim, "").replace(/<\/?[^>]+>/gi, ""), o = 0; o < e.htmlTags.length; o++) n = n.replace(new RegExp("<" + e.htmlTags[o], "gi"), "");
                return n;
            }(n),
        ...
        var n = this.getTokenMap(e), o = t.replace(/[\{\}]/g, ""), i = n[o];
        if ("undefined" != typeof i) return "function" == typeof i ? i(e, n) : i;
        throw new Error("Unknown token: " + t + ", url:" + this.url);
    }, t.fn.rss = function(t, n, o) {
        return new e(this, t, n, o).render(), this;
    };
}(jQuery);
...
$(".mmx-docs-chapter").each(function() {
    ...
    $("#mmx-document-nav > ul").append("<li><a href='#" + link_text + "'>" + nav_name + "</a><ul class='subnav'></ul></li>");
    $(this).find("h3.mmx-docs-heading").each(function(index) {
        var newid = $(this).attr("id").replace(/ /g, "");
        $(this).attr("id", newid);
        var nav_name = $(this).text();
        var link_text = nav_name.replace(/ /g, "");
        $(".subnav").last().append("<li><a href='#" + link_text + "'>" + nav_name + "</a></li>");
    });
});
...
$("#rss-feeds").rss("https://github.com/Metamatrix/MmxComponentLib/commits/master.atom?token=AF6z2jWhqZt8O44ww1eMs0Gw8yrF_Dp3ks61QacrwA%3D%3D", {
    limit: 100,
    filterLimit: 1,
