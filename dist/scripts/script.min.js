    ...
    function loadreadystatechange(xhr) {
        xhr.onreadystatechange = function() {
            if (4 === xhr.readyState) {
                ...
                cachedDocument.body.innerHTML = xhr.responseText, xhr._cachedTarget = {}), xhr._embeds.splice(0).map(function(item) {
...
(function($, win, doc) {
    "use strict";
    var handlers = {}, enhancers = {}, enhancerRequires = {};
    ...
    function initEnhancers(context) {
        ...
        enhancers.each(function() {
            var enhancer = $(this).attr("data-enhancer"), split = enhancer.split(" "), $this = this;
...
(function($, win, modernizr) {
    ...
    $.enhancer("googleMap", function() {
        var map, google, mapCanvas = this, geocoder, ready = false, mapKey = "AIzaSyCXAqKp9r9-ZeIZ-ayV6MkqG7qmIc8z_28", location = $(this).data("location"), initialized = false, googleApiLoaded = win["google"] != null && win["google"]["map"] != null;
        function init() {
...
(function($) {
    $.enhancer("loginForm", function() {
        var loginType = $(this).find("select"), ssn = $("#LoginViewModel_PersonalNumber"), ssnWrapper = ssn.closest(".collapse");
...
(function($, win) {
    "use strict";
    var serviceUrl = "", bankIdUrl = "", pollDelay = 1e3, autostart = false, polling = false, loginType = "1", interval, startButtonDelay = 5;
    ...
    $.enhancer("loginStatus", function() {
        ...
        if (autostart) {
            setTimeout(tryStartBankIdApp, 1e3);
            setTimeout(function() {
                $("#autostart-wrapper").removeClass("hidden");
            }, startButtonDelay * 1e3);
        }
...
(function($) {
    "use strict";
    var callback = function() {
        var formControl = $(this), hasValue = formControl.val().length > 0;
...
(function($, doc) {
    var $doc = $(doc), $body = $("body"), opener, container, lastFocus, menu, overlay, openClass = "open";
    function showMenu() {
        opener = $(this);
        ...
        var menuIsHidden = !menu.attr("aria-hidden") || menu.attr("aria-hidden").toLowerCase() === "true", docHeight = $doc.height(), focusTarget = $(opener.data("focus-target")), iphone4 = navigator.userAgent.match(/iPhone/i) !== null && window.screen.height === 960 / 2;
        if (iphone4 && menu.height() < docHeight) {
            menu.height(docHeight).css("position", "absolute");
            overlay.height(docHeight);
        }
        opener.attr("aria-expanded", menuIsHidden);
        menu.attr("tabIndex", -1).toggleClass("open", menuIsHidden).attr("aria-hidden", !menuIsHidden);
    ...
    function hideMenu() {
        ...
        menu.toggleClass("open", false).attr("aria-hidden", true);
    ...
    function trapTabKey(e) {
        if (e.keyCode === 9) {
            var focusableItemsSelector = "a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, *[tabindex], *[contenteditable]", focusableItems = menu.find(focusableItemsSelector).filter(":visible"), focusedItem = $(":focus"), numberOfFocusableItems = focusableItems.length, focusedItemIndex = focusableItems.index(focusedItem);
            if (e.shiftKey) {
...
(function($) {
    ...
    $.enhancer("xform", function() {
        ...
        form.find(".orientationVertical :radio").after('<span class="input-control">').parent().wrap('<div class="radio styled-radio styled-input-default">');
        form.find(".orientationHorizontal :radio").after('<span class="input-control">').parent().wrap('<div class="radio-inline styled-radio-inline styled-input-default">');
        form.find(".orientationVertical :checkbox").after('<span class="input-control">').parent().wrap('<div class="checkbox styled-checkbox styled-input-default">');
        form.find(".orientationHorizontal :checkbox").after('<span class="input-control">').parent().wrap('<div class="checkbox-inline styled-checkbox-inline styled-input-default">');
...
(function($) {
    ...
    $.handler("scrollLink", function(e) {
        e.preventDefault();
        var href = $(this).attr("href"), target = $($(this).attr("href"));
        if (target.length) {
            var scrollToOpts = {
                offset: -50,
                onAfter: function() {
