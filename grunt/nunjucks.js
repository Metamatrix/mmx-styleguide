module.exports = function(grunt, options){
  ...
  // TODO: Is it possible to load from file?
  var utils = {
    uniqueId: (function() {
        var ids = {},
    ...
    hex2rgb: function(hex) {
      if((hex.length === 4 || hex.length === 7) && hex.indexOf("#") === 0) {
        hex = hex.substring(1);
      }
